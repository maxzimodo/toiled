...
//----------------------------------------footer------------------------------------------------------------------------
document.getElementById("footer").innerHTML = '<div class="container clearfix"><div class="pull-left">Small information <a href="about.html">about</a> our label</br>Don’t hesitate to write us letters: <a href="mailto:toiledrec@gmail.com" >toiledrec@gmail.com</a></div><div class="pull-right"><a href="https://soundcloud.com/user-903374575" target="_blank"><img src="img/soundcloud.svg" alt="" class="soundcloud"></a></div></div>';