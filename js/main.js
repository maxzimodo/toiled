...
//----------------------------------------footer------------------------------------------------------------------------
document.getElementById("footer").innerHTML = '<div class="container clearfix"><div class="pull-left">Small information <a href="about.html">about</a> our label</br>Don’t hesitate to write us letters: <a href="mailto:toiledrec@gmail.com" >toiledrec@gmail.com</a></div><div class="pull-right"><a href="https://www.instagram.com/toiledrecords" target="_blank"><img src="img/instagram.svg" alt="" class="instagram"></a><a href="https://soundcloud.com/toiledrecords" target="_blank"><img src="img/soundcloud.svg" alt="" class="soundcloud"></a></div></div>';